(function () {
    ...
    function initExample (part) {
        if (part===2) {
            ...
            example6.drawNewGraph(false,23/20);
        }
        else if (part===3) {
